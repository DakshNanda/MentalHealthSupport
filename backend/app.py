...
def playlists():
    ...
    if latest_mood:
        sentiment = latest_mood[1]
        if sentiment == 'positive':
            playlist = "https://open.spotify.com/playlist/0t2A2rfRHsYVdAPybNGlUN?si=VbO1cbt-QwKm4-TT8Y49Dw"
            text="Here are some upbeat songs to vibe to!"
        elif sentiment == 'neutral':
            playlist = "https://open.spotify.com/playlist/37i9dQZF1DWTwbZHrJRIgD?si=3Q_NsUcVRLaJiYu6X8bZ7w"
            text="Here are some wholesome songs to listen and just relax."
        else:
            playlist = "https://open.spotify.com/playlist/0l1jbuWw2q2j3yJe0xDIo0?si=EKNNyMkKQl6P9a7FtGz-xQ"
            text="Maybe hearing these songs will help cheer you up."
        
        return render_template('playlists.html', activities=playlist, mood=latest_mood[0],sentiment_text=text), 200
